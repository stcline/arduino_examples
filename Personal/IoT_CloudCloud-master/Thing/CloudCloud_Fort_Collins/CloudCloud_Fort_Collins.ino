 ...
 * definitions below.
 * 
 * This sketch has been modified to use a different wifi network and the weather app is 
 * located on Pitzer College in Claremont, CA.
 * 
 * Modified on 10 July 2018 by Steve Cline
 */
...
// WiFi parameters
const char WIFI_SSID[] = "The Hottest Spot 2.4";
const char WIFI_PSK[] = "4?530R2d";
const char BLYNK_AUTH[] = "e2226201e48e42ec8fb66a98760d6bf1";
...
// Location data (Fort Collins, CO)
const float LATITUDE = 40.59;
const float LONGITUDE = -105.08;
