...
// WiFi parameters
const char WIFI_SSID[] = "NETGEAR53";
const char WIFI_PSK[] = "freebreeze045";
const char BLYNK_AUTH[] = "AxqPjMMctoZZbst7-zXXOF3TJdJNzNnR";
...
// Location data (Claremont, CA)
const float LATITUDE = 34.1;
const float LONGITUDE = -117.72;
