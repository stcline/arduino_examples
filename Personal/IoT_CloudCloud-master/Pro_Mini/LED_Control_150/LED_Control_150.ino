...
Adafruit_NeoPixel strip_b = Adafruit_NeoPixel(150, CLOUD_B_PIN, NEO_GRB + NEO_KHZ800);

/*
Adafruit_NeoPixel strip_b = Adafruit_NeoPixel(150, CLOUD_A_PIN, 
                                        NEO_GRB + NEO_KHZ800);
                                        
Adafruit_NeoPixel strip_a = Adafruit_NeoPixel(150, CLOUD_B_PIN, 
                                        NEO_GRB + NEO_KHZ800);*/
LEDState led_state;
...
void clearCloud(){
  for (int i = 0; i < 150; i++){ //for all the LEDs
  ...
  switch ( night_state ) {
    ...
    case NIGHT_6:
      if ( (millis() - led_time) >= 50 ) {
        ...
        night_state = NIGHT_1;
        led_time = millis();
        night_i = (night_i + 15) % 150;  // Increment/reset index
      }
      break;
...
void sunSet(){  
  ...
  for(i=261; i<150; i++) {  //for LEDs 261 to the last LED
     strip_a.setPixelColor(i, wheel(((i * 256 / 150)) & 255));  //set LEDs to the first part of the color wheel (red-yellow) in cloud one
     strip_b.setPixelColor(i, wheel(((i * 256 / 150)) & 255));  //set LEDs to the first part of the color wheel (red-yellow) in cloud two
  }
  ...
  if ( (millis() - led_time) >= storm_delay ) {
    switch ( storm_state ) {
      ...
      case 10:
        ...
        break;
      case 11:
        multipleFlashs_a(20, 125, 150, 150, 50, 5, strip_a.Color(255,255,255));
        break;
      case 12:
        flickerFlash_a(50, 150, 50, 25, strip_a.Color(200,200,255));
        break;
      case 13:
        multipleFlashs_a(20, 125, 150, 150, 50, 5, strip_a.Color(255,255,255));
        break;
      ...
      case 22:
        ...
        break;
      case 23:
        multipleFlashs_a(20, 125, 175, 150, 50, 5, strip_a.Color(255,255,255));
        break;
      case 24:
      ...
      case 29:
        ...
        break;
      case 30:
        multipleFlashs_a(20, 125, 200, 150, 50, 5, strip_a.Color(255,255,255));
        break;
      case 31:
      ...
      case 33:
        ...
        break;
      case 34:
        jumpingFlash_a(250, 150, 50, strip_a.Color(255,255,255));
        break;
      case 35:
        jumpingFlash_a(250, 150, 50, strip_a.Color(255,255,255));
        break;
      ...
      case 41:
        ...
        break;
      case 42:
        scrollingFlash_a(250, 150, 50, 5, strip_a.Color(255,255,255));
        break;
      case 43:
        flickerFlash_a(0, 100, 50, 50, strip_a.Color(200,200,255));
        break;
      case 44:
        ...
        break;
      case 45:
        multipleFlashs_a(20, 125, 150, 150, 50, 5, strip_a.Color(200,200,255));
        break;
      case 46:
        wholeCloudFlash_a(40, 100, strip_a.Color(255,255,255));
        break;
